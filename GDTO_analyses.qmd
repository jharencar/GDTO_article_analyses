...
ggsave("figures/Figure_2_Chemistry_plot_free_scale.png", device = "png", width = 18, height = 19, units = "cm")
ggsave("figures/Figure_2_Chemistry_plot_free_scale.pdf", device = "pdf", width = 18, height = 19, units = "cm")
```
...
#ggsave("figures/beetle_choice_plot", device = "png", width = 5, height = 5, units = "cm")
...
ggsave("figures/beetle_preference_plot.png", device = "png", width = 12, height = 10, units = "cm")
```
...
ggsave("figures/Figure_3_Herbivory_patterns.pdf", device = "pdf", width = 23, height = 8, units = "cm")
```
