...
palette_check(c("#cc79a7",  "#56B4E9","#f0e442", "#50be73"), plot = TRUE)

#plot
pdf("figures/Figure_VillClade.pdf",  width=6,height=6)  
#par(cex.lab=1) #mar=c(5, 4, 1.4, 0.2),
for (i in 1:nrow(sis.sum)) {
  ...
  points(sis.c$Axis1,sis.c$Axis2, col="#f0e442", pch=1, lwd=2) #vill yellow
  ...
  legend("bottomleft", 
         ...
         col = c("#009E73", "#56B4E9", "#cc79a7",  "#f0e442"), 
         pch = 1, 
         bty = "n",
         pt.cex = 1.5, 
         cex = 1, 
...
##########################################
# Make ran ge maps for C. allenii and C. villosissimus
##########################################
...
#ggsave("figures/Chemistry_plot_free_scale.png", device = "png", width = 18, height = 20, units = "cm")
```
...
#ggsave("figures/RLB_feeding_trials_plot", device = "png", width = 13, height = 7, units = "cm")
...
#ggsave("figures/Herbivory_Arrays_herbivory_estimates.png", device = "png", width = 7, height = 7, units = "cm")
